    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          {!mostrarFormulario && (
            <div className="flex justify-end">
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-4 py-2 rounded-xl transition-colors shadow-sm"
              >
                    ...
                    <div className="space-y-1.5 flex-1">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="text-[10px] font-semibold bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full flex items-center gap-1">
                          <User className="w-3 h-3" /> {ent.entrevistador}
                        </span>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs pt-1">
                        {ent.conocimiento_experiencia && (
                          <div className="bg-slate-50 p-2 rounded-lg border border-slate-100">
                            ...
                            <span className="text-slate-600">{ent.conocimiento_experiencia}</span>
                          </div>
                        )}
                        {ent.evaluacion && (
                          <div className="bg-slate-50 p-2 rounded-lg border border-slate-100">
                            <span className="font-semibold text-slate-700 block text-[11px]">Evaluación:</span> 
                            <span className="text-slate-600">{ent.evaluacion}</span>
                          </div>
                        )}
                      </div>
        ...
        <div className="px-6 py-3 bg-slate-50 border-t border-slate-200 flex justify-end">
          <button
            onClick={onClose}
            className="bg-slate-200 hover:bg-slate-300 text-slate-700 text-xs font-semibold px-4 py-2 rounded-lg transition-colors"
          >
            Cerrar Ventana
          </button>
        </div>
